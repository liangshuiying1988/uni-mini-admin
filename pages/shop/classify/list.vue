<template>
	<view class="fix-top-window">
		...
		<view class="uni-container">
			<unicloud-db ref="gcdb" collection="opendb-banner" :where="where"
...
<script>
	import {filterToWhere} from '@/js_sdk/validator/opendb-banner.js';

	const db = uniCloud.database()
	// 表查询配置
	const dbSearchFields = ['status'] // 支持模糊搜索的字段列表
	const pageSize = 20
	const pageCurrent = 1
